...
public class Test {
    ...
    private static void createArrayTest() {
        System.out.println("Создание ArrayList_StanislavFedin с вместимостью по умолчанию...");
        IntensiveList<Object> initArray = new ArrayList_StanislavFedin<>();
        System.out.println("Успех!");

        System.out.println("Создание ArrayList_StanislavFedin с кастомной вместимостью...");
        IntensiveList<Object> customCapacityArray = new ArrayList_StanislavFedin<>(5);
        System.out.println("Успех!");

        System.out.println("Создание ArrayList_StanislavFedin с отрицательной вместимостью...");
        try {
    ...
    private static void addElementTest() {
    ...
    private static void setElementTest() {
    ...
    private static void clearArrayTest() {
    ...
    private static void splitArrayTest() {
